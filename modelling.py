...
def setup_dagshub():
    ...
    if os.environ.get("GITHUB_ACTIONS") == "true":
        print("Mendeteksi GitHub Actions. Menggunakan penyimpanan folder lokal murni...")
        # Paksa MLflow menulis log ke folder lokal murni di dalam server GitHub
        mlflow.set_tracking_uri("file://" + os.path.join(os.getcwd(), "mlruns"))
        mlflow.set_experiment("Diabetes_Retraining_Clean")
    else:
        print("Mendeteksi lingkungan Lokal laptop...")
        # Jika dijalankan di laptopmu, dia akan tetap aman menembak DagsHub cloud
